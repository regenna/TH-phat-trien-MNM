        ...
        <div class="col-lg-6 col-md-8">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="/THMNM/project2/Product/save" enctype="multipart/form-data" class="needs-validation" novalidate onsubmit="return validateForm();">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted">Chọn file ảnh (tùy chọn, định dạng: JPG, PNG, ...).</small>
                        </div>
